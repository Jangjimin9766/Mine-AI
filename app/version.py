...
def get_runtime_info() -> dict:
    ...
    return {
        ...
        **_magazine_contract_info(),
        ...
        "moodboard_width": int(os.getenv("MOODBOARD_WIDTH", "1024")),
        "moodboard_height": int(os.getenv("MOODBOARD_HEIGHT", "1024")),
        "moodboard_steps": int(os.getenv("MOODBOARD_STEPS", "14")),
