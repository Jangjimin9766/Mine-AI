...
- Each paragraph must be LONG and DETAILED (800-1000 chars minimum)
...
1. **SECTION STRUCTURE**:
   ...
   - `paragraphs`: Array of 3 paragraph objects, each with:
     ...
     * `text`: Paragraph content (plain text or simple HTML, **800-1000 chars MINIMUM**). Must include background context, specific details, and reader-relevant insight.
...
2. **CONTENT DISTRIBUTION**:
   ...
   - **EACH PARAGRAPH TEXT MUST BE 800-1000 CHARACTERS (Korean)**
            ...
            "paragraphs": [
                {
                    ...
                    "text": "첫 번째 문단. 구체적인 장소/아이템 소개. 배경 맥락과 역사, 구체적 디테일(가격, 위치, 특징), 독자를 위한 팁, 체험적 묘사를 모두 포함하여 충분히 길고 밀도 있게 작성 (800-1000자)",
                    "image_search_keyword": "Steaming Korean Pork Soup in traditional bowl",
                    "image_url": null
                },
                {
                    "subtitle": "문단 소제목 (예: 여름의 별미, 밀면)",
                    "text": "두 번째 문단. 다른 장소/아이템 소개. 해당 아이템의 유래나 트렌드 흐름, 대표 매장이나 브랜드 정보, 방문 시 유의사항이나 추천 조합 등을 깊이 있게 서술 (800-1000자)",
                    "image_search_keyword": "Korean cold noodles with egg garnish",
                    "image_url": null
                },
                {
                    "subtitle": "문단 소제목 (예: 바다의 보물창고)",
                    "text": "세 번째 문단. 또 다른 장소/아이템 소개. 현장의 분위기와 감각적 묘사, 가격대와 접근성, 현지인 추천 포인트, 계절별 특색 등을 담아 풍성하게 작성 (800-1000자)",
...
- [ ] Is each paragraph text AT LEAST 800 characters? -> EXPAND IT with more context, details, and descriptions.
